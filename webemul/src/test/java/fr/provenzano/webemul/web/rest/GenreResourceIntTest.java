...
import fr.provenzano.webemul.web.rest.GenreResource;
import fr.provenzano.webemul.web.rest.TestUtil;
...
public class GenreResourceIntTest {
    ...
    private static final Integer DEFAULT_IGDB_ID = 1;
    private static final Integer UPDATED_IGDB_ID = 2;
    ...
    public void createGenre() throws Exception {
        ...
        assertThat(testGenre.getIgdbID()).isEqualTo(DEFAULT_IGDB_ID);
    }
    ...
    @Test
    @Transactional
    public void checkIgdbIDIsRequired() throws Exception {
        int databaseSizeBeforeTest = genreRepository.findAll().size();
        // set the field null
        genre.setIgdbID(null);
    ...
    public void getAllGenres() throws Exception {
        ...
        restGenreMockMvc.perform(get("/api/genres?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].igdbID").value(hasItem(DEFAULT_IGDB_ID)));
    }
    ...
    public void getGenre() throws Exception {
        ...
        restGenreMockMvc.perform(get("/api/genres/{id}", genre.getId()))
            ...
            .andExpect(jsonPath("$.igdbID").value(DEFAULT_IGDB_ID));
    }
    ...
    public void updateGenre() throws Exception {
        ...
        assertThat(testGenre.getIgdbID()).isEqualTo(UPDATED_IGDB_ID);
    }
