...
gulp.task('images', function() {
	  return gulp.src(config.app + 'content/images/**/*.{gif,jpg,png}')
	    .pipe(gulp.dest(config.dist + '/content/images'));
	});
...
gulp.task('spinner', function() {
	  return gulp.src(config.app + 'touch-spin/**/*.{js,css}')
	    .pipe(gulp.dest(config.dist + '/touch-spin'));
	});

gulp.task('extlibs', function() {
	  return gulp.src(config.app + 'lib-ext/**/*.{js,css,map}')
	    .pipe(gulp.dest(config.dist + '/lib-ext'));
	});
...
gulp.task('assets:prod', ['extlibs', 'images', 'styles', 'html', 'copy:swagger', 'copy:images'], build);
